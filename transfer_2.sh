...
# Define variables
SOURCE_FILE="/var/www/html/callanalog/admin/sip_additional.conf"
DESTINATION_SERVER="37.61.219.110"
DESTINATION_PORT="19645"  # Change to the actual SSH port of the destination server
DESTINATION_DIRECTORY="/etc/asterisk/sip_additional.conf"  # Change to the desired directory on the destination server

...
<div class="main-content">
	<div class="section__content section__content--p30 page_mid">
		<div class="container-fluid">
			...
			<div class="overview-wrap table_top_heading">
				<a
					href="http://edu.bigpbx.com/bigpbxnew/bigpbx/agentwisecallreport.php?username=<?php echo $_GET['username']; ?>&start=<?php echo $_GET['start']; ?>&end=<?php echo $_GET['end']; ?>">
					<button class="au-btn au-btn-icon au-btn--blue">
										...
										if (count($row_wait['amount']) > 0 and $countryname != 'Canada' and $countryname != 'Cocos (Keeling); Islands') {
											...
											<tr style="color:white;text-align: left;">
												<td style="text-align: left;cursor:pointer;"><a
														href="acallcountry.php?country=<?php echo $countrypre; ?>&start=<?php echo $start; ?>&end=<?php echo $end; ?>&user=<?php echo $_GET['username']; ?>">
														<?php echo $countryname . ' ' . $countrypre; ?>
													</a></td>
												<td style="text-align: left;">
													<?php echo round($row_wait['amount'], 3); ?>
												</td>
												<td style="text-align: left;">
													<?php echo round(($row_wait['amount'] / $row_wait['total']), 3); ?>
												</td>
												<td style="text-align: left;">
													<?php echo $row_wait['totaltime']; ?>
												</td>
												<td style="text-align: left;">
													<?php echo round(($row_wait['totaltime'] / $row_wait['total']), 0); ?>
												</td>
												<td style="text-align: left;">
													<?php echo $row_wait['total']; ?>
												</td>
											</tr>
										<?php }
									}
							...
							<thead>
								<tr style="text-align: left;background-color:yellow;">
									...
									<th style="text-align: left;">Total Cost ( In USD ) =
										<?php echo round($totalcostall, 3); ?>
									</th>
									<th style="text-align: left;">Total Avg. Cost ( In USD ) =
										<?php echo round($totalcostall, 3); ?>
									</th>
									<th style="text-align: left;">Total Duration ( In Seconds )=
										<?php echo $totaltime; ?>
									</th>
									<th style="text-align: left;">Total Avg. Duration ( In Seconds )=
										<?php echo round(($totaltime / $totalcountry), 0); ?>
									</th>
									<th style="text-align: left;">Total Call =
										<?php echo $totalcountry; ?>
									</th>
								</tr>
							</thead>
						</table>

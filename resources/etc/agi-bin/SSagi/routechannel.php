...
require ('/var/www/html/bigpbx/AGI/lib/phpagi/phpagi.php'); // I do not know if it's really necessary, as I said at the beginning, I know very little about PHP and AGI
        ...
        $connection = mysql_connect("localhost","root","GFDUedThsS");
        mysql_select_db("bigdialer",$connection);

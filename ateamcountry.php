...
<a href="http://edu.bigpbx.com/bigpbxnew/bigpbx/ateamrecord.php?start=<?php echo $_GET['start']; ?>&end=<?php echo $_GET['end'];?>&username=<?php echo $_GET['user']; ?>">
...
// $totalcallrecord = mysqli_num_rows($result_waiting);
	...
	<tr style="color:white;text-align: left;" >
		...
		<td style="text-align: left;"><?php echo $rowcon['stoptime']; ?></td>
		<td style="text-align: left;"><?php echo $rowcon['sessiontime']; ?></td>
		<td style="text-align: left;"><?php echo $rowcon['calledstation']; ?></td>
		<td style="text-align: left;"><?php echo $rowcon['sessionbill']; ?></td>

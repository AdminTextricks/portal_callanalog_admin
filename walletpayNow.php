        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <h4 class="card-header bg-primary text-white text-center p-4" style="padding:10px;">Callanalog
                            Payment Form</h4>
                                    ...
                                    <form method="post" id="paymentFrm">
                                        <div class="form-group">
                                            <input name="gatway_invoice_id" id="gatway_invoice_id"
                                                ...
                                                value="<?php echo $rowid['invoice_id']; ?>" readonly required="">
                                        </div>
                                        <div class="form-group" style="display:none;">
                                            <input name="invoice_id" id="invoice_id" class="form-control input-field-pay"
                                                type="text" value="<?php echo $rowid['id']; ?>" required />
                                        </div>
                                        <div class="form-group">
                                            <input name="paid_amount" id="paid_amount" class="form-control input-field-pay"
                                                type="hidden" value="<?php echo $rowid['invoice_amount']; ?>" readonly
                                                required="">
                                        </div>
                                        <div class="form-group">
                                            <input name="currency" id="currency" class="form-control input-field-pay"
                                                type="text" value="<?php echo $rowid['invoice_currency']; ?>" readonly
                                                required="">
                                        </div>

                                        <div class="form-group">
                                            <input type="text" name="user_name" id="user_name"
                                                class="form-control input-field-pay" placeholder="Card Holder Name"
                                                value="<?php echo $user_row['firstname']; ?>" readonly required="">
                                        </div>
                                        ...
                                        <div class="form-group" style="display:block;">
                                            <input name="item_number" id="item_number" class="form-control input-field-pay"
                                                type="text" value="<?php echo $item_str; ?>" readonly>
                                        </div>
                                        ...
                                        <input type="hidden" id="renew" name="renew" value="<?php echo $_GET['renew']; ?>">
                                        <div class="form-group text-right">
                                            <button class="btn btn-warning " type="reset">Reset</button>
                                            <button type="button" id="payBtn" name="submit" class="btn btn-primary">Submit
                                                Payment</button>
                                        </div>
                                    </form>
                                <?php } else { ?>
                    ...
                    $("#payBtn").click(function (event) {
                        ...
                        if (user_name != "" && paid_amount != "" && gatway_invoice_id != "") {
                            $.ajax({
                                ...
                                dataType: 'JSON',
                                data: { gatway_invoice_id: gatway_invoice_id, invoice_id: invoice_id, paid_amount: paid_amount, currency: currency, user_name: user_name, email: email, user_id: user_id, item_name: item_name, item_number: item_number, item_type: item_type, payment_type: payment_type,renew:renew },

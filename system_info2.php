...
$script_path = "/var/www/html/callanalog/admin/serverdetails2.sh";
// Execute the shell script
$response = shell_exec("bash " . $script_path);
// echo '<pre>';print_r($response);exit;
// $response = file_get_contents('system_info2.txt');
$lines = explode("\n", $response);
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="overview-wrap">
                        <h2 class="title-1">Server Details(37.61.219.110)

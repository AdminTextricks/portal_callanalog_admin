...
<div class="main-content">
    <div class="section__content section__content--p30 page_mid">
        <div class="container-fluid">
            ...
            // echo $sipQuery;exit;
            $sipRecords = mysqli_query($con, $sipQuery);
            while ($sip_row = mysqli_fetch_assoc($sipRecords)) {
                //echo '<pre>'; print_r($sip_row); echo '</pre>'; exit;
                $item_name_arr[] = $sip_row['name'];
            }
            //$item_name = $sip_row['name'];            
            // echo '<pre>';print_r( $item_name_arr);exit; 
            ...
            $invoice_amount = $price_row['price'] * count($item_name_arr);
            ...
            foreach ($item_name_arr as $key => $item_name) {
